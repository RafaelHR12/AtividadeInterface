...
public class TelaCadastroOperador {
	...
	public static void main(String[] args) {
		...
		// Caixa de texto flutuante (explica o que o usuário deve preencher em
		// determinado campo)
		...
		// Agrupar componentes:
		Object[] componentes = { nomeOperador, txNome, idOperador, txId, cpf, txCpf, endereco, rua, txRua, cep, txCep,
				bairro, txBairro, numero, txNumero, complemento, txComplemento };
		...
		if (operador.verificarCadastro(txNome.getText(), txId.getText(), txCpf.getText()) && endereco1
				.verificarEndereco(txRua.getText(), txCep.getText(), txBairro.getText(), txNumero.getText())) {
